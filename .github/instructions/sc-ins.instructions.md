...
---
        ...
        Author comments:
        - Always add author name and date at the top of the code snippets.
        - Name: Franz Phillip G. Domingo

        logs: 
        - add a short description of the changes made inside logs/chatbotlogs.md
        - format should be: YYYY-MM-DD: description of changes made (Franz Phillip G. Domingo)